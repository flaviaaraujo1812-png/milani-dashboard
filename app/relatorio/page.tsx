...
const entradasAtual = totalEntradas(dadosMesAtual)
const despesasAtual = totalDespesas(dadosMesAtual)
const dividasAtual = totalDividas(dadosMesAtual)
const lucroAtual = lucro(dadosMesAtual)

const entradasAnterior = totalEntradas(dadosMesAnterior)
const despesasAnterior = totalDespesas(dadosMesAnterior)
const dividasAnterior = totalDividas(dadosMesAnterior)
const lucroAnterior = lucro(dadosMesAnterior)
...
<div style={{
  ...
  <div style={{
    ...
    <div style={{
      ...
      <div style={box}>        <h2 style={tituloSecao}>
          🚗 Resumo Operacional
        </h2>
